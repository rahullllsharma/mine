...
_TILE_GEOMTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="Point", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LineString", index=2, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="Polygon", index=3, number=3, options=None, type=None
        ),
    ],
...
_TILE_VALUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="string_value",
            full_name="mapnik.vector.tile.value.string_value",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="float_value",
            full_name="mapnik.vector.tile.value.float_value",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="double_value",
            full_name="mapnik.vector.tile.value.double_value",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="int_value",
            full_name="mapnik.vector.tile.value.int_value",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="uint_value",
            full_name="mapnik.vector.tile.value.uint_value",
            index=4,
            number=5,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="sint_value",
            full_name="mapnik.vector.tile.value.sint_value",
            index=5,
            number=6,
            type=18,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="bool_value",
            full_name="mapnik.vector.tile.value.bool_value",
            index=6,
            number=7,
            type=8,
            cpp_type=7,
...
_TILE_FEATURE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="mapnik.vector.tile.feature.id",
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="tags",
            full_name="mapnik.vector.tile.feature.tags",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
            ...
            options=_descriptor._ParseOptions(
                descriptor_pb2.FieldOptions(), b"\020\001"
            ),
        ),
        _descriptor.FieldDescriptor(
            name="type",
            full_name="mapnik.vector.tile.feature.type",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="geometry",
            full_name="mapnik.vector.tile.feature.geometry",
            index=3,
            number=4,
            type=13,
            cpp_type=3,
...
_TILE_LAYER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="version",
            full_name="mapnik.vector.tile.layer.version",
            index=0,
            number=15,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="mapnik.vector.tile.layer.name",
            index=1,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="features",
            full_name="mapnik.vector.tile.layer.features",
            index=2,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="keys",
            full_name="mapnik.vector.tile.layer.keys",
            index=3,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="values",
            full_name="mapnik.vector.tile.layer.values",
            index=4,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="extent",
            full_name="mapnik.vector.tile.layer.extent",
            index=5,
            number=5,
            type=13,
            cpp_type=3,
...
_TILE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="layers",
            full_name="mapnik.vector.tile.layers",
            index=0,
            number=3,
            type=11,
            cpp_type=10,
...
_TILE_FEATURE.fields_by_name["tags"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), b"\020\001"
)
_TILE_FEATURE.fields_by_name["geometry"].has_options = True
_TILE_FEATURE.fields_by_name["geometry"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), b"\020\001"
)
