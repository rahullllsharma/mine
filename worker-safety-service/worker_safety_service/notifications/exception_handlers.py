...
def get_status_title(status_code: int) -> str:
    try:
        # Convert status code to an HTTPStatus object
        status = HTTPStatus(status_code)
        # Return the title of the status
...
def http_exception_handler(
    ...
    return ErrorResponse(exc.status_code, get_status_title(exc.status_code), exc.detail)
