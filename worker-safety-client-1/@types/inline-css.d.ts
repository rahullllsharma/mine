...
/**
 * TODO: Removed this once we update the TS version that supports `import { type TYPE }` syntax
 *
 * Manually declaring the type because a inner dependency (cheerio) is having issues with our current TS setup.
 * We don't support the syntax import { type Options } due to the TS version
 *
