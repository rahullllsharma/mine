...
describe("filename.utils", () => {
  describe(generateExportedProjectFilename.name, () => {
    it("should include the project id when defined", () => {
      expect(
        generateExportedProjectFilename({
          project: {
            number: "project-abc",
    ...
    it("should generate include the project name", () => {
      expect(
        generateExportedProjectFilename({
          project: {
            number: "project-abc",
    ...
    it("should output the filename with the project number, project name, chart information and todays date, separated by dashes without the extension", () => {
    ...
    it("should output the filename without the project number when the project id is NOT defined", () => {
      jest.setSystemTime(new Date("2022-03-25T10:25:00.000Z"));
      expect(
        generateExportedProjectFilename({
          project: {
      ...
      ).toEqual("project-name-abc-Project risk over time-Urbint-03/25/22");
    });
  });
  ...
  describe(generateExportedPortfolioFilename.name, () => {
    ...
    it("should output the filename with the tenant, chart information and todays date, separated by dashes without the extension", () => {
      jest.setSystemTime(new Date("2022-03-25T10:25:00.000Z"));
      expect(
        generateExportedPortfolioFilename({
