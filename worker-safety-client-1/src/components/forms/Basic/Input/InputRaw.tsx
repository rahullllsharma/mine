...
export function InputRaw(props: InputRawProps): JSX.Element {
  ...
  return (
    <div className="w-full" id={props.id}>
      ...
      <div
        className={cx(
          "relative flex w-full items-center text-base font-normal text-neutral-shade-100 border border-solid rounded-md bg-neutral-light-100",
          props.hasError
      ...
      >
        ...
        <input
          ...
          data-testid={props.dataTestId ?? "input-" + (props.type ?? "text")}
