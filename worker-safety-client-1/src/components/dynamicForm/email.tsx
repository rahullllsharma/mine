...
type ResponseOption = "manual_input" | "auto_populate_user_email";
...
const responseOptions: RadioGroupOption[] = [
  {
    id: 1,
    value: "auto_populate_user_email",
    description: "Auto populate user email",
  },
