...
export default {
  title: "Container/Insights/Charts/ProjectTaskRiskHeatmap",
  component: ProjectTaskRiskHeatmap,
} as ComponentMeta<typeof ProjectTaskRiskHeatmap>;

const Template: ComponentStory<typeof ProjectTaskRiskHeatmap> = args => (
  <ProjectTaskRiskHeatmap filters={sampleProjectFilters} {...args} />
);
