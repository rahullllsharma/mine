 ...
 * @internal
 */
export function _registerCustomQueryHandler(name, handler) {
 ...
 * @internal
 */
export function _unregisterCustomQueryHandler(name) {
 ...
 * @internal
 */
export function _customQueryHandlerNames() {
 ...
 * @internal
 */
export function _clearCustomQueryHandlers() {
    _customQueryHandlerNames().forEach(_unregisterCustomQueryHandler);
}
/**
 * @internal
 */
export function _getQueryHandlerAndSelector(selector) {
