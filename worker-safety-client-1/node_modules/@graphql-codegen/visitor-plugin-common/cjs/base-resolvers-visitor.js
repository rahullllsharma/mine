...
class BaseResolversVisitor extends base_visitor_js_1.BaseVisitor {
    constructor(rawConfig, additionalConfig, _schema, defaultScalars = scalars_js_1.DEFAULT_SCALARS) {
        ...
        super(rawConfig, {
            ...
            avoidOptionals: (0, utils_js_1.getConfigValue)(rawConfig.avoidOptionals, false),
        ...
        this._hasReferencedResolversUnionParentTypes = false;
    ...
    createResolversFields({ applyWrapper, clearWrapper, getTypeToUse, referencedUnionType, shouldInclude, }) {
    ...
    createResolversUnionTypes({ getTypeToUse, }) {
    ...
    buildResolversUnionParentTypes() {
        ...
        return new utils_js_1.DeclarationBlock(this._declarationBlockConfig)
            ...
            .withBlock(Object.entries(this._resolversUnionParentTypes)
            .map(([typeName, value]) => (0, utils_js_1.indent)(`${typeName}: ${value}${this.getPunctuation(declarationKind)}`))
            .join('\n')).string;
    }
    get schema() {
    ...
    FieldDefinition(node, key, parent) {
        ...
        return (parentName) => {
            ...
            const avoidOptionals = typeof this.config.avoidOptionals === 'object'
                ? (_d = this.config.avoidOptionals) === null || _d === void 0 ? void 0 : _d.resolvers
    ...
    getRelevantFieldsToOmit({ schemaType, shouldInclude, getTypeToUse, }) {
        ...
        return this._federation
            ...
            const addOptionalSign = !this.config.avoidOptionals && !(0, graphql_1.isNonNullType)(field.type);
            return {
                addOptionalSign,
                fieldName,
