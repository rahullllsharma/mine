...
var ease = (0, import_bezier_easing.default)(0.25, 0.1, 0.25, 1);
var easeIn = (0, import_bezier_easing.default)(0.42, 0, 1, 1);
var easeOut = (0, import_bezier_easing.default)(0, 0, 0.58, 1);
var easeInOut = (0, import_bezier_easing.default)(0.42, 0, 0.58, 1);
var easingFunctions = {
  linear: (value) => value,
  ease,
  "ease-in": easeIn,
...
function getEasingFunctionFromString(easing) {
  ...
  if (easing.indexOf("cubic-bezier(") === 0) {
    ...
    easingFunctions[easing] = (0, import_bezier_easing.default)(bezierArray[0], bezierArray[1], bezierArray[2], bezierArray[3]);
    return easingFunctions[easing];
  }
