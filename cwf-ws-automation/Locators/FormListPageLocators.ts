export const FormListPageLocators = {
  ...
  JSB_Summary_Page:{
    mobile: "//button[contains(.,'JSB Summary')]",
    desktop: "//button[contains(.,'JSB Summary')]",
  },
  JSB_Summary_ContentArea: {
    mobile: "//section[contains(@class,'flex-1 w-full')]",
    desktop: "//section[contains(@class,'flex-1 w-full')]",
  },
  JSB_Summary_PageExpansion1:{
    mobile: "(//i[@class='ci-chevron_big_down text-xl'])[2]",
    desktop: "(//i[@class='ci-chevron_big_down text-xl'])[2]",
  },
  JSB_Summary_BurgerMenuBtn: {
    mobile: "//div[@class='relative z-20']",
    desktop: "//div[@class='relative z-20']",
  },
  JSB_Summary_DownloadBtn: {
    mobile: "(//button[contains(@class,'flex flex-1')])[3]",
    desktop: "(//button[contains(@class,'flex flex-1')])[3]",
  },
  JSB_btnNavSignOff: {
